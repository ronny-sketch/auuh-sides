...
// Each clip straddles a real, named event from docs/cue-sheet.md.
const CLIPS = [
  { name: "flash_1067", center: 1067.19, before: 2.0, after: 2.0 },
  { name: "fracture_entry_1980", center: 1980.04, before: 3.0, after: 3.0 },
...
async function main() {
  ...
  await browser.close();
  console.log("all preview clips rendered");
}
